...
public class VoiceAssistantHTTPServer extends NanoHTTPD {
    ...
    public Response serve(IHTTPSession session) {
        ...
        if (session.getMethod() == Method.POST) {
            try {
                ...
                String response = getJavaResponse(recognizedText); // Get Java program's response
    ...
    private void sendEmail() {
        final String fromEmail = "projectfriday2024@gmail.com";
        final String password = "Friday@123";
